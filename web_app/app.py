...
p_model = joblib.load('/medication_ai/models/xgboost/com_xgboost.pkl')
le_model = joblib.load('/medication_ai/models/xgboost/LabelEncoder.pkl')

# list of symptoms
symptom_list = []

with open('/medication_ai/common_diseases.txt') as file:
